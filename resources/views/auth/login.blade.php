...
@section('title', 'Login - Ratu Minang')
    ...
    <div class="rm-auth-card">
        ...
        <div class="rm-auth-header">
            <svg class="rm-auth-crown" width="44" height="36" viewBox="0 0 100 80" fill="none">
                <path d="M50 5L62 30L85 10L75 55H25L15 10L38 30L50 5Z" fill="url(#lging)" stroke="#C9A84C" stroke-width="1.5"/>
                <path d="M50 30L56 42H44L50 30Z" fill="#8B6914"/>
                <defs>
                    <linearGradient id="lging" x1="0" y1="0" x2="100" y2="100" gradientUnits="userSpaceOnUse">
            ...
            <h2 class="rm-auth-title">Selamat Datang</h2>
            <p class="rm-auth-sub">Silakan masuk ke akun Anda</p>
        </div>
        ...
        <form action="/login" method="POST">
            ...
            <div class="rm-auth-group" style="margin-bottom: 26px;">
                <label class="rm-auth-label">Password</label>
                <input type="password" name="password" required placeholder="Masukkan password" class="rm-auth-input">
            </div>

            <button type="submit" class="rm-auth-submit">Masuk</button>
        </form>
